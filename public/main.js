...
var $author$project$Main$init = {code: ''};
...
var $author$project$Main$ArrayLit = function (a) {
	return {$: 'ArrayLit', a: a};
};
var $author$project$Main$BindLit = F3(
	function (a, b, c) {
		return {$: 'BindLit', a: a, b: b, c: c};
	});
var $author$project$Main$CallLit = F2(
	function (a, b) {
		return {$: 'CallLit', a: a, b: b};
	});
var $elm$parser$Parser$Done = function (a) {
	return {$: 'Done', a: a};
};
var $elm$parser$Parser$Forbidden = {$: 'Forbidden'};
var $author$project$Main$IfElseLit = F3(
	function (a, b, c) {
		return {$: 'IfElseLit', a: a, b: b, c: c};
	});
var $author$project$Main$IndexLit = F2(
	function (a, b) {
		return {$: 'IndexLit', a: a, b: b};
	});
var $author$project$Main$LambdaLit = F2(
	function (a, b) {
		return {$: 'LambdaLit', a: a, b: b};
	});
var $elm$parser$Parser$Loop = function (a) {
	return {$: 'Loop', a: a};
};
var $author$project$Main$TupleLit = function (a) {
	return {$: 'TupleLit', a: a};
};
var $author$project$Main$VarLit = function (a) {
	return {$: 'VarLit', a: a};
};
...
var $author$project$Main$BoolLit = function (a) {
	return {$: 'BoolLit', a: a};
};
...
var $author$project$Main$symb = function (s) {
	return A2(
		$elm$parser$Parser$map,
		function (_v0) {
			return s;
...
var $author$project$Main$parseBool = A2(
	$elm$parser$Parser$map,
	function (s) {
		return $author$project$Main$BoolLit(s === 'true');
	},
	$elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				$author$project$Main$symb('true'),
				$author$project$Main$symb('false')
			])));
...
var $author$project$Main$parseInfixOp = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
...
var $author$project$Main$IntLit = function (a) {
	return {$: 'IntLit', a: a};
};
...
var $author$project$Main$parseInt = $elm$parser$Parser$number(
	{
		...
		_int: $elm$core$Maybe$Just($author$project$Main$IntLit),
		octal: $elm$core$Maybe$Nothing
	});
var $author$project$Main$NoneLit = {$: 'NoneLit'};
var $author$project$Main$parseNone = A2(
	$elm$parser$Parser$map,
	function (_v0) {
		return $author$project$Main$NoneLit;
	},
	$elm$parser$Parser$keyword('none'));
var $author$project$Main$parsePrefixOp = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			$author$project$Main$symb('!'),
			A2(
...
var $author$project$Main$parseString = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed($author$project$Main$StringLit),
						...
						_List_fromArray(
							[
								...
								A2(
									...
									function (op) {
										return A2(
											...
											function (right) {
												return A2(
													$author$project$Main$CallLit,
													$author$project$Main$VarLit(op),
													_List_fromArray(
														[left, right]));
											},
											A2(
								...
								A2(
									...
									$author$project$Main$CallLit(lit),
									$elm$parser$Parser$Loop),
								$elm$parser$Parser$sequence(
									{
										end: ')',
										item: $author$project$Main$cyclic$parse(),
										separator: ',',
										spaces: $author$project$Main$ws,
										start: '(',
								...
								A2(
									...
									A2(
										$elm$parser$Parser$ignorer,
										$elm$parser$Parser$succeed(
											$author$project$Main$IndexLit(lit)),
										$elm$parser$Parser$symbol('[')),
									A2(
										$elm$parser$Parser$ignorer,
										$author$project$Main$cyclic$parse(),
										$elm$parser$Parser$symbol(']')))),
								$elm$parser$Parser$succeed(
								$elm$parser$Parser$Done(left))
							])),
					$author$project$Main$ws));
		});
};
function $author$project$Main$cyclic$parseLit() {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$parser$Parser$ignorer,
							$elm$parser$Parser$succeed($author$project$Main$IfElseLit),
...
function $author$project$Main$cyclic$parseArray() {
	return A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed($author$project$Main$ArrayLit),
		$elm$parser$Parser$sequence(
			{
				end: ']',
				item: $author$project$Main$cyclic$parse(),
...
function $author$project$Main$cyclic$parenthetical() {
	return A2(
		$elm$parser$Parser$andThen,
		function (expr) {
			if (expr.$ === 'TupleLit') {
						...
						[
							...
							function (body) {
								return A2(
									...
									$elm$parser$Parser$problem('function with non-identifier arguments'),
									A2(
										$elm$core$Maybe$map,
										function (args) {
											return $elm$parser$Parser$succeed(
												A2($author$project$Main$LambdaLit, args, body));
										},
										A3(
											$elm$core$List$foldr,
											F2(
							...
							function () {
								if (xs.b && (!xs.b.b)) {
									...
									return $author$project$Main$TupleLit(xs);
								}
							}())
						]));
			} else {
				return $elm$parser$Parser$succeed(expr);
			}
		},
		A2(
			$elm$parser$Parser$keeper,
			$elm$parser$Parser$succeed($author$project$Main$TupleLit),
			$elm$parser$Parser$sequence(
				{
					end: ')',
					item: $author$project$Main$cyclic$parse(),
...
function $author$project$Main$cyclic$parse() {
	return A2(
		$elm$parser$Parser$andThen,
		$author$project$Main$compoundExpr,
		A2(
			$elm$parser$Parser$keeper,
			A2(
				$elm$parser$Parser$ignorer,
							...
							function (op) {
								return A2(
									...
									$elm$parser$Parser$lazy(
										function (_v0) {
											return $author$project$Main$cyclic$parse();
										}));
							},
							$author$project$Main$parsePrefixOp),
							$elm$parser$Parser$lazy(
							function (_v1) {
								return $author$project$Main$cyclic$parseLit();
							})
						])),
				$author$project$Main$ws)));
}
					...
					[
						...
						A2(
							...
							A2(
								$elm$parser$Parser$ignorer,
								$elm$parser$Parser$succeed(
									$author$project$Main$BindLit(_var)),
								$elm$parser$Parser$symbol('=')),
							A2(
								$elm$parser$Parser$ignorer,
								$author$project$Main$cyclic$parse(),
						...
						$author$project$Main$cyclic$parse()),
						$elm$parser$Parser$succeed(
						$author$project$Main$VarLit(_var))
					]));
		},
		A2(
			$elm$parser$Parser$ignorer,
...
try {
	var $author$project$Main$parseLit = $author$project$Main$cyclic$parseLit();
	...
	var $author$project$Main$parseArray = $author$project$Main$cyclic$parseArray();
	$author$project$Main$cyclic$parseArray = function () {
		return $author$project$Main$parseArray;
	};
	var $author$project$Main$parenthetical = $author$project$Main$cyclic$parenthetical();
	$author$project$Main$cyclic$parenthetical = function () {
		return $author$project$Main$parenthetical;
	};
	var $author$project$Main$parse = $author$project$Main$cyclic$parse();
	$author$project$Main$cyclic$parse = function () {
		return $author$project$Main$parse;
	};
...
var $author$project$Main$go = $elm$parser$Parser$run(
	A2($elm$parser$Parser$ignorer, $author$project$Main$parse, $elm$parser$Parser$end));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('David-Ryan Language')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Enter code below!')
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$placeholder('Write some DRL code! Example: ((x)->(y)->x)((x)->x)(3)'),
								$elm$html$Html$Events$onInput($author$project$Main$NewCode)
							]),
						_List_Nil),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						(model.code === '') ? $elm$html$Html$text('') : A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								...
								$elm$core$Debug$toString(
									$author$project$Main$go(model.code)))
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
